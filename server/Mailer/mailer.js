 ...
 */
async function sendEnquiryEmail({ name, email, phone, subject, message }) {
  const mailOptions = {
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 20px; border: 1px solid #e6e9ec; border-radius: 8px;">
        ...
        <table style="width: 100%; border-collapse: collapse; margin-top: 15px;">
          ...
          <tr>
            <td style="padding: 8px 0; color: #00706F; font-weight: 600;">Subject:</td>
            <td style="padding: 8px 0; color: #082B5C;">${subject || "—"}</td>
          </tr>
        </table>
