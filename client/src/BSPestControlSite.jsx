...
const SERVICE_AREAS = ["Ottawa", "Kanata", "Nepean", "Barrhaven", "Orleans", "Stittsville", "Brampton", "& More"];
      ...
      >
        ...
        >
          <a href="#home" className="flex items-center gap-2">
            <div
              className="w-10 h-10 rounded-md flex items-center justify-center text-white font-bold text-lg font-display"
...
/>
            ...
            return (
              <Reveal key={pest.name} delay={i * 60} className="pest-tile flex flex-col items-center gap-2">
                {pest.img ? (
                  ...
                  <div
                    className="pest-icon-wrap w-16 h-16 rounded-full flex items-center justify-center"
        ...
        <div className="max-w-7xl mx-auto px-4 grid lg:grid-cols-2 gap-10 items-center">
          ...
          <Reveal delay={120}>
            ...
            <h2 className="text-2xl md:text-3xl font-bold mb-4" style={{ color: COLORS.primary }}>
              Your Local Pest Control Partner in <span style={{ color: COLORS.accent }}>Ontario</span>
            </h2>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {SERVICES.map((service, i) => (
              ...
              >
                ...
                <div className="p-6">
                  <h3 className="font-bold mb-2 text-sm" style={{ color: COLORS.primary }}>
                    {service.name}
                  </h3>
                  <p className="text-xs leading-relaxed mb-3">{service.blurb}</p>
                  <a
                    href="#contact"
              ...
              {WHY_CHOOSE_US.map((item) => {
                ...
                return (
                  <div key={item.title} className="flex gap-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-sm mb-1" style={{ color: COLORS.primary }}>
                        {item.title}
                      </h4>
            ...
            {PROCESS_STEPS.map((step, i) => {
              ...
              return (
                <Reveal key={step.num} delay={i * 100} className="flex flex-col items-center">
                  ...
                  <p className="text-xs max-w-[180px]">{step.text}</p>
                </Reveal>
              );
            })}
          </div>
      ...
      {/* Service areas */}
      <section id="areas" className="py-16 bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 grid lg:grid-cols-2 gap-10 items-center">
          <Reveal>
            <SectionEyebrow>Service Areas</SectionEyebrow>
            <h2 className="text-2xl md:text-3xl font-bold mb-4" style={{ color: COLORS.primary }}>
              Proudly Serving <span style={{ color: COLORS.accent }}>Across Ontario</span>
            </h2>
            <p className="text-sm mb-6">
              We provide pest control services in major cities and surrounding areas across Ontario.
            </p>
            ...
            <Button variant="navy">View All Service Areas</Button>
          </Reveal>

          <Reveal delay={120} className="img-zoom rounded-xl h-72 shadow-lg">
            <img src={IMG.areas} alt="Ontario neighbourhood served by PESTEXIT " className="w-full h-full object-cover" />
          </Reveal>
        </div>
      </section>
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            {BLOG_POSTS.map((post, i) => (
              <Reveal key={post.title} delay={i * 100} className="lift-card rounded-xl overflow-hidden shadow-sm">
                ...
                <div className="p-5">
                  <h4 className="font-bold text-sm mb-2 leading-snug" style={{ color: COLORS.primary }}>
                    {post.title}
                  </h4>
                  <p className="text-xs mb-3">{post.excerpt}</p>
        ...
        <div className="max-w-7xl mx-auto px-4 py-14 grid sm:grid-cols-2 lg:grid-cols-4 gap-10">
          <div>
            <div className="flex items-center gap-2 mb-4">
              <div
                className="w-20 h-20 rounded-md flex items-center justify-center font-bold font-display"
                style={{ backgroundColor: COLORS.accent }}
              >
             <img
  src={logo}
...
/>
            ...
            <p className="text-sm text-white/70 mb-4">
              Expert pest control services for homes &amp; businesses across Ontario.
            </p>
